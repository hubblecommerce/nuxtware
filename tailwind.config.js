  ...
  theme: {
    extend: {
      colors: {
        ...
        'focus-color': 'var(--primary-color-shade-light)',
        'input-color': 'var(--input-color, --border-color)',
        'input-color-content': 'var(--input-color-content)',
        'label-color': 'var(--label-color, var(--neutral-color))',
      },
    },
  },
  variants: {},
