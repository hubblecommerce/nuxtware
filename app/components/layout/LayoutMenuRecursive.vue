...
watch(activeSubcategory, (newVal, oldVal) => {
    // TODO: Going deeper, focus "back" button of recursive child component by ref
    if (newVal && oldVal === null) {
        console.log('down');
    }

    // TODO: Going up, focus "category" button of this component instance by ref
